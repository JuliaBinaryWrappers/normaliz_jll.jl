# Autogenerated wrapper script for normaliz_jll for x86_64-apple-darwin14-cxx11
...
const libnormaliz_splitpath = ["lib", "libnormaliz.3.dylib"]
...
const libnormaliz = "@rpath/libnormaliz.3.dylib"
